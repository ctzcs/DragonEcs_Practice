...
namespace Share.Input
{
    public struct InputData : IEcsWorldComponent<InputData>
    {
        ...
        public bool WasReleaseThisFrame(EKeyCode keyCode) => GetRecord(keyCode).WasReleasedInThisFrame;
        public bool WasPressedThisFrame(EKeyCode keyCode) => GetRecord(keyCode).WasPressedInThisFrame;
